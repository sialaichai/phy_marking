...
<style>
    ...
    /* Mobile-optimized table - FITS WITHOUT SCROLLING */
    .stDataFrame {
        width: 100% !important;
...
# ========================================================
    ...
    # ---------- Upload Mark Scheme (with Question File) ----------
        ...
        with st.form("mark_scheme_form"):
            ...
            if submitted:
                # Validate: at least question text OR file must be provided
                if not assignment_name:
                    ...
                    if question_file is not None:
                        # Read file data and encode as base64 for storage
    ...
    # ---------- View Marks (GROUPED BY CLASS) ----------
        ...
        if not schemes:
            ...
            for scheme in schemes:
                ...
                # Show question file if available
                    ...
                    if scheme.get('question_file_data'):
                        ...
                        try:
                            ...
                            if 'pdf' in file_type.lower() or file_name.lower().endswith('.pdf'):
                                # For PDFs, provide a download button
                                st.download_button(
                    ...
                    if submitted:
                        ...
                        if not student_name:
                            ...
                            with st.spinner("Grading..."):
                                ...
                                # Get the question text (use file content if no text)
